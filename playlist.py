...
add_song(my_playlist, {'artist': 'Babeheaven', 'title': 'Heaven'})
'''
...
add_song(my_playlist, {'artist': 'Nilufer Yanya', 'title': 'Shameless'})
add_song(my_playlist, {'artist': 'Grimes', 'title': 'Genesis'})
